...
if (/Android|Windows Phone|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
	...
	if (url.match(/\/\/www\.xbiquge\.la\//)) {
		Go('https://websiteintegration.github.io/Novel/mobile');
	}

	id = url.match(/\/\d+\/(\d+)\//);
	if (id) {
		Go('https://websiteintegration.github.io/Novel/mobile/wapbook/' + id[1] + '.html');
	}

	id = url.match(/\/\d+\/(\d+)\/(\d+).html/);
	if (id) {
		Go('https://websiteintegration.github.io/Novel/mobile/wapbook/' + id[1] + '_' + id[2] + '.html');
	}
